...
class HybridSearchResult:
    ...
    sparse_rrf_contribution: float = 0.0
...
class HybridSearchResponse:
    ...
    sparse_candidates_requested: int = 0
    sparse_results_found: int = 0
