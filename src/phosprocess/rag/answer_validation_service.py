"""Objective citation validation, response assembly, and source binding."""
...
from phosprocess.rag.retrieval_service import RAGRetrievalError, _RetrievedContext
...
class AnswerValidationService:
    """Enforce format/provenance invariants without judging factual meaning."""
