...
def main() -> None:
    ...
    summary = {
        "method": "hybrid_reranked_expanded_query",
        "split": "dev",
    ...
    summary_path = (
        RESULTS_DIRECTORY
        / "dev_hybrid_reranked_v2_expanded_query_summary.json"
    )

    details_path = (
        RESULTS_DIRECTORY
        / "dev_hybrid_reranked_v2_expanded_query_per_query.csv"
    )
